export const translations = {
  en: {
    ...
    services: {
      title: 'What I do',
      subtitle: 'End-to-end digital product development, from concept to shipped.',
      items: [
        {
          id: 1,
          icon: 'Code2',
    ...
    projects: {
      ...
      contactDesc: 'Inspired by this project? I\'d love to build something similar for you.',
    ...
    contact: {
      ...
      info: {
        ...
        locationValue: 'Remote · Buenos Aires, Argentina',
        responseLabel: 'Response time',
        responseValue: '2 hours',
        statusLabel: 'Available for inquiries',
  ...
  es: {
    ...
    projects: {
      ...
      contactDesc: '¿Inspirado por este proyecto? Me encantaría construir algo similar para ti.',
    ...
    contact: {
      ...
      info: {
        ...
        statusLabel: 'Disponible para consultas',
